...
const int servoPins[18] = {52, 50, 48,    42, 40, 38,    53, 51, 49,    22, 24, 26,    28, 30, 32,    23, 25, 27};
//const int servoPins[18] = {52, 10, 11,    12, 13, 14,    15, 16, 17,    18, 20, 8,    9, 6, 7,    5, 4, 3};
//const uint8_t pinServo[18]  = {   2,  A8,   5,     A5,   8,  A2,      3,  A7,   6,     A4,   9,  A1,      4,  A6,   7,     A3,  10,  A0  };
...
// Settings                                   
int servoAngleOffset[18] = {     -90, -90, -90, 
                                 -90, -90, -90,  
                                 -90, -90, -90, 
                                 -90, -90, -90, 
                                 -90, -90, -90, 
