...
//                if(device.getName().equals("EasyBT"))
    ...
    void openBT() throws IOException
    {
        ...
        Log.w("net.dankocher.hexapod", "Bluetooth Opened");
    }
                                ...
                                if(b == delimiter)
                                {
                                    ...
                                    handler.post(new Runnable()
                                    {
                                        public void run()
                                        {
                                            ...
                                            Log.w("net.dankocher.hexapod", "Serial: " + data);
                                        }
                                    });
                                }
                                else
    ...
    void sendData(String msg) throws IOException
    {
        ...
        Log.w("net.dankocher.hexapod", "Serial Data send: " + msg);
    }
    ...
    void closeBT() throws IOException
    {
        ...
        Log.w("net.dankocher.hexapod", "Bluetooth Closed");
    }
}
